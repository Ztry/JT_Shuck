...
tasks.register("prepareCentralBundle") {
    ...
    val groupId: String = project.findProperty("mavenCentral.groupId") as String? ?: "io.github.ztry"
    val artifactId: String = project.findProperty("mavenCentral.artifactId") as String? ?: "jt-shuck-library"
